...
const addOneLiner = (num1, num2) => {return `${num1} + ${num2} = ${num1 + num2}`;};
...
// Answer: arrow functions wont work with prototypes and constructior functions.
...
// It refers to the whole constructor object , in this case (joe),
//but since scope() uses console.log instead of return it gives the object and unidentified.

// 2. What is "this" when joe.scopeArrow() is invoked?
//It refers to the constructor objectied.

// 3. Explain why "this" is different when an arrow function is used.
// Since arrow functions does not work with prototypes, it returned an unidentifed.
